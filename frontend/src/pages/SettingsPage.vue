    ...
    <div class="settings-container">
      <header class="settings-header">
        ...
        <div class="settings-header__right">
          <button type="button" class="theme-switch-btn" :title="t('theme.toggle')" @click="toggleTheme">
...
html.dark .settings-page {
  background: linear-gradient(135deg, #0b141a 0%, #111b21 100%) !important;
}

html[data-theme="dark"] .settings-container,
html.dark .settings-container {
  background: rgba(30, 36, 40, 0.85) !important;
  border-color: rgba(255, 255, 255, 0.1) !important;
  color: #e9edef !important;
}

html[data-theme="dark"] .settings-header__left h1,
html.dark .settings-header__left h1,
...
html[data-theme="dark"] .field-compact input,
html.dark .field-compact input,
html[data-theme="dark"] .field-compact textarea,
html.dark .field-compact textarea {
